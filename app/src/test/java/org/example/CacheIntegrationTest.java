...
public class CacheIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        // Set MyBatis logging to DEBUG for benchmark testing
        Logger mybatisLogger = (Logger) LoggerFactory.getLogger("org.apache.ibatis");
        Logger mapperLogger = (Logger) LoggerFactory.getLogger("org.example.mapper");
        Logger cacheLogger = (Logger) LoggerFactory.getLogger("org.apache.ibatis.cache");
        Logger caffeineLogger = (Logger) LoggerFactory.getLogger("org.mybatis.caches.caffeine");
        
        mybatisLogger.setLevel(Level.DEBUG);
        mapperLogger.setLevel(Level.DEBUG);
        cacheLogger.setLevel(Level.DEBUG);
        caffeineLogger.setLevel(Level.DEBUG);
